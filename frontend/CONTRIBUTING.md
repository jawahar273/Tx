...
> Tx Front-end is based on [react boilerplate](https://github.com/react-boilerplate/react-boilerplate) and Tx Front-end always try
to follow the standards of the `react boilerplate`

Love react-boilerplate(with Tx) and want to help? Thanks so much, there's something to do for everybody!
